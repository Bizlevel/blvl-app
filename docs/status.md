...
Задача 25.0: Подготовлен план задач для замены онбординга на стартовый уровень «Первый шаг». Обновлён `docs/bizlevel-implementation-plan-phase6.md` (добавлены Задачи 25.1–25.8). Изменений в коде не вносилось.
