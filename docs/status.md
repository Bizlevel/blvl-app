...
- Экран `GpStoreScreen` переведён на компактный одноэкранный дизайн: шапка с балансом, выбор плана через чипы (3 варианта), отображается только выбранный план, снизу sticky‑бар CTA.
