...
- Чекпоинт L4: добавлен диалог с Максом («Обсудить с Максом») и кнопка «Завершить чекпоинт → /goal». - не работает
- Чекпоинт L7: добавлены «Обсудить с Максом» и «Настроить напоминания». - соответсвует не полностью.
