...
```
Башня БизЛевел (идет снизу вверх)
├── Ресепшн (онбординг) - отдельный блок
├── Этаж 1: База предпринимательства (уровни 1-10)
├── Этаж 2: Продвинутый предприниматель (уровни 11-20) 
├── Этаж 3: Команда и процессы (уровни 21-30)
└── Этаж 4: Масштабирование (уровни 31-40)
```

#### 2.2 Визуальные зоны

**Каждый этаж представляет собой визуально отделенную зону с разным задним фоном:**
...
- **Визуал:** Полностью развернут, яркие цвета, с фоном этажа
- **Карточки уровней:** в свернутом виде - квадратные, синие с галочкой или замком или звездой (та же логика иконок, что и на карточках уровней). Текущий уровень - звездочка и золотистая кайма (как сейчас на карточках уровней). При тапе на карточку - открывается карточка уровня в развернутом виде (как сейчас).
- **Очередность уровней:** 1 - внизу, вверх по возрастанию.
...
- **Визуал:** Затемненный/размытый фон. Не переходит без активации (кроме первого этажа - он виден. Активация - тап на этаж - значок лифта)
...
1. **Новый пользователь:** Показ начала карты (ресепшн - Уровень 0)
...
- Изначальная загрузка: текущий этаж + 2-3 уровней вверх и вниз
- Подгрузка: по 3 уровней при приближении к границе
