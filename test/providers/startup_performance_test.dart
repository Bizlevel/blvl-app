...
void main() {
  ...
  group('🚀 Startup Performance Tests', () {
    test('currentUserProvider completes within 500ms (no blocking)', () async {
      ...
      // ignore: avoid_print
      print('✅ currentUserProvider completed in ${stopwatch.elapsedMilliseconds}ms');
    });
    ...
    test('gpBalanceProvider completes within 500ms (no blocking)', () async {
      ...
      // ignore: avoid_print
      print('✅ gpBalanceProvider completed in ${stopwatch.elapsedMilliseconds}ms');
    });
    ...
    test('authStateProvider can be watched without timeout', () async {
      ...
      // ignore: avoid_print
      print('✅ authStateProvider watched in ${stopwatch.elapsedMilliseconds}ms');
    });
    ...
    test('supabaseClientProvider is synchronous', () {
      ...
      // ignore: avoid_print
      print('✅ supabaseClientProvider read in ${stopwatch.elapsedMilliseconds}ms');
    });
  });

  group('🔒 Auth Provider Chain Tests', () {
    test('currentUserProvider does NOT await authStateProvider.future', () async {
      ...
      await container.read(currentUserProvider.future).timeout(
        ...
        onTimeout: () => throw TimeoutException(
          'currentUserProvider is blocking! '
    ...
    test('Multiple providers can be read concurrently', () async {
      ...
      // ignore: avoid_print
      print('✅ Concurrent reads completed in ${stopwatch.elapsedMilliseconds}ms');
    });
  });
}
