...
5. **Текущий уровень**: Если указан текущий уровень обучения - давай советы только по пройденным темам (уроки 1-{уровень}), не перескакивай на темы уроков, которые пользователь еще не изучил
